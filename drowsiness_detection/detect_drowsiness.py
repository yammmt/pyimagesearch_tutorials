...
# define two constants, one for the eye aspect ratio to indicate blink and then
# a second constant for the number of consecutive frames the eye must be below
#the threshold for to set off the alarm
EYE_AR_THRESH = 0.3
EYE_AR_CONSEC_FRAMES = 48
# initialize the frame counter as well as a boolean used to indicate if the
# alarm is going off
COUNTER = 0
ALARM_ON = False
...
while True:
    # grab the frame from the threaded video file stream, resize it, and convert
    # it to grayscale channels
    frame = vs.read()
