...
for c in cnts:
    # compute the bouinding box of the contour, then use the bounding box to
    # derive the aspect ratio
    (x, y, w, h) = cv2.boundingRect(c)
    ar = w / float(h)

    # in order to label the contour as a question, region should be sufficiently
    # wide, sufficiently tall, and have an aspect ratio approximately equal to 1
